...
\setlength{\headheight}{14.5pt}
  ...
  \titolo{Ottimizzazione dell'algoritmo BM25P}
  \titoloeng{Optimization of BM25P algorithm}
  \laureando{Federico Silvestri}
  \annoaccademico{2019-2020}
  %\facolta{Scienze Matematiche, Fisiche e Naturali}
  \corsodilaureatriennalein{Informatica}
  \relatore[Prof.]{Cristina Ioana Muntean}
  \relatoreDue[Prof.]{Franco Maria Nardini}
  \correlatore[Prof.]{Maria Simi}
  \dedica{Dedicato ai miei genitori, che mi hanno sempre aiutato, e agli amici che mi hanno sempre sostenuto}
...
% Per l'ipertesto:
 ...
 \hypersetup{
  ...
  pdftitle={Optimization of BM25P algorithm},
  pdfauthor={Federico Silvestri},
  pdfsubject={Tesis of Bachelor Degree in Computer Science},
  pdfkeywords={Tesis Bachelor Degree Computer Science Federico Silvestri}
  }
